...
local script_Version = "0.2"               -- Версия скрипта
---
...
function main()
  ...
  autoupdate("https://raw.githubusercontent.com/Drey4ik/GHelper/refs/heads/main/version.json", tag, "http://vk.com/drey4ikk")
